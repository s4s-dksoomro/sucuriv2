...
@section('content')
    <h3 class="page-title">Enterprise Log Share Analysis</h3>
    <p>
                        ...
                        @foreach ($zones as $zone)
                            <tr data-entry-id="{{ $zone->id }}">
                                ...
                                <td>
                                     ...
                                     <input class="elsSetting" zone-name="{{$zone->name}}"   zone-id="{{$zone->id}}"  type="checkbox" data-onstyle="success" data-offstyle="default" {{ $zone->els === 1 ? "checked" : "" }} data-toggle="toggle" data-on="Enabled" data-off=" Disabled">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if($zone->els==1)
                                    <a href="els/{{ $zone->name }}">Admin View</a>
                                    <br>
                                    <a href="els/{{ $zone->name }}/clientview">Client View</a>
                                    @endif
                                </td>
