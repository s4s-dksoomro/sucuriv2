    ...
    ! function d(a, b, c) {
        ...
        2: [function(b, d, e) {
            ...
            var f = (b("./handle-swal-dom"), b("./handle-dom")),
                ...
                h = function(a, b) {
                    var c = !0;
                    (0, f.hasClass)(a, "show-input") && (c = a.querySelector("textarea").value, c || (c = "")), b.doneFunction(c), b.closeOnConfirm && sweetAlert.close(), b.showLoaderOnConfirm && sweetAlert.disableButtons()
                },
                i = function(a, b) {
        ...
        5: [function(d, e, f) {
            ...
            var h = d("./handle-dom"),
                ...
                q = function() {
                    var a = p();
                    return a ? a.querySelector("textarea") : void 0
                },
                r = function() {
