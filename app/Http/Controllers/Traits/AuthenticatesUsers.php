...
use Illuminate\Foundation\Auth\AuthenticatesUsers as ParentAuth;
use Illuminate\Foundation\Auth\RedirectsUsers as RedirectsUsers;
use Illuminate\Foundation\Auth\ThrottlesLogins as ThrottlesLogins;
trait AuthenticatesUsers 
{
    ...
    public function showLoginForm(Request $request)
    {
        ...
        $branding=\App\Branding::where('url',$host)->first();
        // dd($branding);
